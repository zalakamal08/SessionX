...
/**
 * Centralized design system for SessionX UI.
 * All colors, fonts, and spacing constants live here.
 */
public final class UiTheme {

    // --- Color Palette ---
    public static final Color BG_DEEP      = new Color(0x0D, 0x11, 0x17);
    public static final Color BG_SURFACE   = new Color(0x16, 0x1B, 0x22);
    public static final Color BG_ELEVATED  = new Color(0x21, 0x26, 0x2D);
    ...
    public static final Color ACCENT_ORANGE= new Color(0xD2, 0x99, 0x22);
    public static final Color ACCENT_RED   = new Color(0xF8, 0x51, 0x49);
    ...
    public static javax.swing.JButton primaryButton(String text) {
        ...
        b.setBackground(new Color(0x23, 0x8A, 0x39));
